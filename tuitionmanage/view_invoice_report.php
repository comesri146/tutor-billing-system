    ...
    <div class="container mt-5">
      ...
      <form method="post" class="form-inline mb-3">
        ...
        if (isBranchAdmin($conn, $branchId, $username)) {
            echo '<a href="branch_admin_dashboard.php" class="btn btn-primary">Back to admin Dashboard</a>';
        } else {
            echo '<a href="master_dashboard.php" class="btn btn-primary">Back to Master Dashboard</a>';
        }
        ?>
