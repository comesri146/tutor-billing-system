...
if (isset($_POST['addNewInvoice'])) {
    ...
    $branchID = $_SESSION['branch_id'];
    $studentID = getStudentIDByContact($conn, $_POST['contact']);
...
$sql = "INSERT INTO invoices (branch_id, student_id, invoice_number, grand_total, invoice_date, student_name, contact_number, address, paid_amount, due_amount, balance_amount, invoice_status, subject_name)
VALUES ('$branchID', '$studentID', '$invoiceNumber', '$grandTotal', CAST('$invoiceDate' AS DATE), '$studentName', '$contact', '$address', '$paidAmount', '$dueamount','$balance_amount', '$invoiceStatus', '$subjectNamesString')";
...
<div class="alert alert-warning mt-3" id="warningMessage" style="display: none;">
    Paid amount should be greater than or equal to 50% of the grand total.
</div>

    <div class="container mt-5">
        <!-- Add New Invoice Form -->
        <form action="invoice_operations.php" method="post" id="newInvoiceForm" class="row">
...
<div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="paidAmount" id="paidAmount" required>
</div>
...
<div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="dueAmount" id="dueAmount" readonly>
            ...
            <div class="form-group col-md-12">
                <button type="submit" name="addNewInvoice" class="btn btn-primary">Add New Invoice</button>
            </div>
        </form>
...
function checkPaidAmountValidity() {
    ...
    if (paidAmount < minValidPaidAmount) {
        ...
        // You can also disable the submit button or take other actions if needed
