...
<div class="top-buttons text-center">
    <button class="btn btn-info my-1 btn-text" onclick="viewBranchSubjects()">View Subjects</button>
    <button class="btn btn-primary my-1 btn-text" onclick="toggleFormVisibility()">Add Subject</button>
    <button class="btn btn-success my-1 btn-text" onclick="toggleBranchFormVisibility()">Add Branch</button>
    <button class="btn btn-warning  my-1 btn-text" onclick="toggleAdminFormVisibility()">Add Admin</button>
    <div class="row">
        <div class="col-md-8">
